...
### Data Sources
**3. Scraped Dataset: Chicago Data for Crimes and Environment**
**How to Use?**
Step 1:
...
Step 3:
Run **env.py**, and **crimes.py** to get the data for each zip code. In each
...
b. find_zip_codes(gdf_zip, points):
    ...
    as a csv file.
c. def info():
    Finally this function takes the csv file generated and sum the number of crimes
    and environmental hazards per zip code.

**3. Scraped Dataset: Chicago Data for Schools**

Run **school.py**, to get the education score for each zip code. This is done
through several functions that are linked together to get the data:
    ...
    The final score is an average between both of them.
